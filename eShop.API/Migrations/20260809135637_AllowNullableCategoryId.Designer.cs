...
namespace eShop.API.Migrations
{
    ...
    [Migration("20260809135637_AllowNullableCategoryId")]
    partial class AllowNullableCategoryId
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CR.Core.Domain.AuthToken.NotificationToken", b =>
                {
                    ...
                    b.ToTable("NotificationToken", "public");
                });
            ...
            modelBuilder.Entity("CR.Core.Domain.Catalog.AttributeValue", b =>
                {
                    ...
                    b.ToTable("AttributeValue", "public");
                });
            ...
            modelBuilder.Entity("CR.Core.Domain.Catalog.CategoryAttribute", b =>
                {
                    ...
                    b.ToTable("CategoryAttribute", "public");
                });
            ...
            modelBuilder.Entity("CR.Core.Domain.Catalog.ProductAttribute", b =>
                {
                    ...
                    b.ToTable("ProductAttribute", "public", t =>
                        {
            ...
            modelBuilder.Entity("CR.Core.Domain.Catalog.ProductVariant", b =>
                {
                    ...
                    b.ToTable("ProductVariant", "public");
                });
            ...
            modelBuilder.Entity("CR.Core.Domain.Catalog.ProductVariantAttribute", b =>
                {
                    ...
                    b.ToTable("ProductVariantAttribute", "public", t =>
                        {
